...
{
    fprintf(stderr,
            /* Description on how to use gde2-calc displayed on command-line */
            _("Usage:\n"
    ...
    fprintf(stderr,
            /* Description on gde2-calc command-line help options displayed on command-line */
            _("Help Options:\n"
    ...
    if (show_gtk) {
        fprintf(stderr,
                /* Description on gde2-calc command-line GTK+ options displayed on command-line */
                _("GTK+ Options:\n"
    ...
    if (show_application) {
        fprintf(stderr,
                /* Description on gde2-calc application options displayed on command-line */
...
int main(int argc, char **argv)
{
    ...
    g_settings_var = g_settings_new ("org.gde2.calc");
